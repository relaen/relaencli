...
exports.PostgresGennerator = void 0;
const basegenerator_1 = require("./basegenerator");
const util_1 = require("./util");
class PostgresGennerator extends basegenerator_1.BaseGenerator {
    async getConn() {
        const pg = require('pg');
        const options = {
    ...
    async genTables(conn) {
        ...
        for (let t of tables['rows']) {
            let en = this.genName(t.tablename, this.config.tableSplit, this.config.tableStart, 0);
    ...
    async genRelations(conn) {
        ...
        for (let r of relations.rows) {
            arr.push({
                ...
                delete: util_1.Util.getConstraintRule(r.deleterule),
                update: util_1.Util.getConstraintRule(r.updaterule),
...
exports.PostgresGennerator = PostgresGennerator;
//# sourceMappingURL=postgresgenerator.js.map